...
ctrl_stick_resting_pos = 0

dxl.set_goal_current(motor_ids, [50, 300])
...
while (time.time() - t_start) < time_duration:
    ...
    delta = int(curr_pos[0] - ctrl_stick_resting_pos)
    

    dxl.set_goal_pos(motor_ids, [ctrl_stick_resting_pos, curr_pos[1] + delta])
